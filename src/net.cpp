...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Reactcoin " + FormatFullVersion();
...
//    {"reactcointools.com", "dnsseed.reactcointools.com"},
//    {"reactcoinpool.org", "dnsseed.reactcoinpool.org"},
...
//    {"reactcointools.com", "testnet-seed.reactcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Reactcoin is probably already running."), addrBind.ToString().c_str());
        else
